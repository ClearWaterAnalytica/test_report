...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20220427/Fig_prediction.png)
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20220427/Fig_chla.pdf){:             width="600px"}{: .align-center}
<br clear="all" />
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20220427/Fig_cyan.pdf){: width="600px"}{: .align-center}
<br clear="all" />
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20220427/Fig_climatology.png){: .     align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20220427/Fig_precip_cumsum.png){: .     align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20220427/Fig_temp_cumsum.png){: .     align-center}
